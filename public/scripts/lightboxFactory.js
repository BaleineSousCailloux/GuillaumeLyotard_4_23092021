...
this.lightboxFactory = (light, directory) => {
  this.getLightboxVue = () => {
    ...
    if (light.video) {
      ...
      <video class="lightbox__content__container__media__insert" data-media-id="${light.id}" poster="../public/images/Photos/${directory}/${light.video}" controls preload="metadata" tabindex="1" aria-label="${light.alt}">
